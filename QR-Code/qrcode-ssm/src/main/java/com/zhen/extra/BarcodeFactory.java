...
public class BarcodeFactory {
    ...
    public static void encode(String content, int width, int height,String formatName,
                              String srcImagePath, String destImagePath) {
        try {
            ImageIO.write(genBarcode(content, width, height, srcImagePath),
                    formatName, new File(destImagePath));
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public static void main(String[] args) {
        BarcodeFactory
                .encode("http://coolshell.cn/articles/10590.html",
                        300, 300,"jpg", "D:\\pic\\pic.jpg", "D:\\pic\\dest.jpg");
    }
