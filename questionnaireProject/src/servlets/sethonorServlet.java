...
/**
 * Servlet implementation class sethonorServlet
 */
@WebServlet("/sethonorServlet")
public class sethonorServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public sethonorServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String sql="UPDATE USR SET IDSTATUS='abnormal' WHERE USRID='"+usrName+"'";
		usrFunction.updateUsr(sql);
		out.println("<script>alert('封号成功');location.href='sethonor.jsp';</script>");
				...
				logObj.setOperation("sethonor:"+usrName);
				//添加日志信息
