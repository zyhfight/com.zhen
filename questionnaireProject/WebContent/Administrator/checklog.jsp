...
<body>
	...
	<fieldset>
	<br><br>
		<div align="center" style="font-weight: bold">查看日志信息</div>
		<div align="center">
		<fieldset>
				<input type="text" name=usrName placeholder="填写要查询的用户名（不填表示全查）"  style="height:40px;width:449px;background-color:#E0EEE0">
		</fieldset>
		<fieldset>
		<div align="left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;时间段：
			<input type="datetime-local" name=startTime style="height:40px;width:200px;background-color:#E0EEE0">
			 --- <input type="datetime-local" name=endTime style="height:40px;width:200px;background-color:#E0EEE0">
		</div>
		</fieldset>
		<fieldset>
