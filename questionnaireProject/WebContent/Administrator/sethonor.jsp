...
<body>
	<form action="sethonor" method="post">
	<fieldset>
	<br><br>
		<div align="center" style="font-weight: bold">封号</div>
		<div align="center">
		<fieldset>
				<input type="text" name=usrName placeholder="填写要查封的用户名" required="required"  style="height:40px;width:449px;background-color:#E0EEE0">
		</fieldset>
		<fieldset>
