...
<body>
	<form action="deknight" method="post">
	<fieldset>
	<br><br>
		<div align="center" style="font-weight: bold">解除封号</div>
		<div align="center">
		<fieldset>
				<input type="text" name=usrName placeholder="填写要解封的用户名" required="required"  style="height:40px;width:449px;background-color:#E0EEE0">
		</fieldset>
		<fieldset>
			<input type="submit" value="确定">
			<input type="button" value="返回" onclick="window.location.href='../Login/welcome3.jsp'">
		</fieldset>	
	</div>
	</fieldset>
	</form>
