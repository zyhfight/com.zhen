...
function validate_form(thisform)
	{
		with (thisform)
  	{
  		if (validate_required(symbol,"请添加样本")==false)
   		 {
  			return false
  		}
  		}
...
<body>
	<div align="center">
		<form action="addSymbol" onsubmit="return validate_form(this)" method="post">
		<fieldset >
			<input type="text" name=symbol placeholder="填写发布人群"  required  style="height:40px;width:449px;background-color:#E0EEE0"> 
		</fieldset>
		<fieldset>
			<input type="submit" value="添加样本">
			<input type="button" value="取消" onclick="window.location.href='addActivity.jsp'">
		</fieldset>			
			<input type="hidden" name="addSymbol" value="addSymbol">
		</form>
	</div>
</body>
</html>